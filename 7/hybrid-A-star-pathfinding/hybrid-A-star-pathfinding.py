...
class HybridAstar:
    ...
    def __init__(self, car, grid, reverse, unit_theta=pi/24, dt=1e-2, check_dubins=1):
        self.car = car
        self.grid = grid
        ...
        # Include half steering to allow gentle curves alongside full-lock turns
        half_phi = self.car.max_phi / 2
        self.phil = [-self.car.max_phi, -half_phi, 0, half_phi, self.car.max_phi]
        self.ml = [1, -1]
    ...
    def get_children(self, node, heu, extra):
        ...
        for m, phi in self.comb:
            ...
            # don't immediately undo the previous step (same phi, opposite direction)
...
if __name__ == '__main__':
    ...
    end_pos = [1.71, 0.3, 1*pi/4] # Target point [x,y, angle]
